...
This solution efficiently groups anagrams using a hash map, where the sorted characters of each string serve as keys. The time complexity is O(N * K * log(K)), where N is the number of strings and K is the maximum length of a string.
